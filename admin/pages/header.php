  ...
  <body class="header-fixed">
    ...
    <nav class="t-header">
      <div class="t-header-brand-wrapper">
        <a href="index.html">
          <img class="logo" src="../../admin/assets/images/logo2.png" alt="Dashboard">
          <img class="logo-mini" src="../../admin/assets/images/logo2.png" alt="">
        </a>
      </div>
    ...
    <div class="page-body">
      ...
      <div class="sidebar">
        ...
        <ul class="navigation-menu">
          ...
          <li>
            <a href="#category-pages" data-toggle="collapse" aria-expanded="false">
              <span class="link-title">Category</span>
              <i class="mdi mdi-account link-icon"></i>
            </a>
            <ul class="collapse navigation-submenu" id="category-pages">
              <li>
                <a href="./workcategoryreg.php" >Registration</a>
              </li>
              <li>
                <a href="./workcategoryview.php" >View</a>
              </li>
            </ul>
          </li>
          <li>
            <a href="#subcategory-pages" data-toggle="collapse" aria-expanded="false">
              <span class="link-title">Sub Category</span>
              <i class="mdi mdi-bullseye link-icon"></i>
            </a>
            <ul class="collapse navigation-submenu" id="subcategory-pages">
              <li>
                <a href="./worksubcategoryreg.php" >Registration</a>
              </li>
              <li>
                <a href="./worksubcategoryview.php" >View</a>
              </li>
            </ul>
          </li>
          <li>
            <a href="#template-pages" data-toggle="collapse" aria-expanded="false">
              <span class="link-title">Template</span>
              <i class="mdi mdi-account link-icon"></i>
            </a>
            <ul class="collapse navigation-submenu" id="template-pages">
              <li>
                <a href="./templatereg.php" >Registration</a>
              </li>
              <li>
                <a href="./templateview2.php" >View</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            <a href="./workrequestview.php">
              <span class="link-title">Work Request</span>
              <i class="mdi mdi-gauge link-icon"></i>
            </a>
          </li>
          <li class="nav-category-divider">VIEW</li>
          <li>
            <a href="./customersview.php">
              <span class="link-title">CUSTOMERS</span>
              <i class="mdi mdi-asterisk link-icon"></i>
            </a>
          </li>
          <li class="nav-category-divider">OTHERS</li>
          <li>
