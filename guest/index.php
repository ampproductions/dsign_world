        ...
        <div class="container">
          <div class="row align-items-center py-lg-8 py-6">
            <div class="col-lg-6 text-center text-lg-start">
              <h1 class="text-white fs-5 fs-xl-6" style="font-family: 'Poppins', sans-serif; font-weight: 900;">The Online<br><span style="color: #65E4A3; font-family: 'Poppins', sans-serif; font-weight: 900;">Designing</span> Solution </h1>
              ...
              <form class="d-flex" role="search">
                <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style="background: transparent; color: white; border: 2px solid #65E4A3;">
                <button class="btn btn-outline-success" type="submit">Search</button>
              </form><br>
              <div class="d-sm-flex align-items-center gap-3">
                <button class="btn btn-success text-black mb-3 w-75">Get Template</button>
